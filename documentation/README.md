The best practices and standards documentation is mastered in this repository and synced to Confluence. In order to preserve a readable structure in Confluence, it relies on some pre-existing pages:
